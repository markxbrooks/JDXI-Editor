            ...
            with mido.open_input(port_name) as inport:
                ...
                for message in inport:
                    ...
                    if message.type == 'control_change':
                        ...
                        if controller == 10:
                            print(f"{timestamp_str:>8}\tFrom {port_name}\tControl\t{channel}\tPan (fine)\t{value}")
                        elif controller == 41:
                            print(f"{timestamp_str:>8}\tFrom {port_name}\tControl\t{channel}\tController 41\t{value}")
                        else:
                        ...
                        print(f"{timestamp_str:>8}\tFrom {port_name}\tProgram Change\t{channel}\tProgram {program}")
                    else:
                        print(f"{timestamp_str:>8}\tFrom {port_name}\t{message.type}\t{message}")
