...
.. py:module:: jdxi_editor.midi.sysex.utils
...
.. autoapisummary::
   ...
   jdxi_editor.midi.sysex.utils.map_range
   jdxi_editor.midi.sysex.utils.calculate_checksum
   jdxi_editor.midi.sysex.utils.bytes_to_hex
   jdxi_editor.midi.sysex.utils.int_to_hex


Module Contents
---------------

.. py:function:: map_range(value: int, in_min: int = -100, in_max: int = 100, out_min: int = 54, out_max: int = 74) -> int
...
.. py:function:: calculate_checksum(data: tuple) -> int
...
.. py:function:: bytes_to_hex(byte_list: list, prefix: str = 'F0') -> Optional[str]
...
.. py:function:: int_to_hex(value: int) -> str
