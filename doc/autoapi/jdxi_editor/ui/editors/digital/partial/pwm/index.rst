...
.. py:module:: jdxi_editor.ui.editors.digital.partial.pwm
...
.. autoapisummary::
   ...
   jdxi_editor.ui.editors.digital.partial.pwm.PWMWidget


Module Contents
---------------

.. py:class:: PWMWidget(pulse_width_param: jdxi_editor.midi.data.parameter.AddressParameter, mod_depth_param: jdxi_editor.midi.data.parameter.AddressParameter, midi_helper: Optional[jdxi_editor.midi.io.helper.MidiIOHelper] = None, controls: dict[jdxi_editor.midi.data.parameter.AddressParameter, PySide6.QtWidgets.QWidget] = None, address: Optional[jdxi_editor.midi.data.address.address.RolandSysExAddress] = None, create_parameter_slider: Callable = None, parent: Optional[PySide6.QtWidgets.QWidget] = None)
   ...
   .. py:attribute:: mod_depth_changed


   .. py:attribute:: pulse_width_changed
   ...
   .. py:attribute:: pulse_width_control


   .. py:attribute:: mod_depth_control
   ...
   .. py:method:: on_pulse_width_changed(val: int) -> None
   ...
   .. py:method:: on_mod_depth_changed(val: int) -> None
