...
.. autoapisummary::
   ...
   pitch.pwm_plot.generate_square_wave


Module Contents
---------------

.. py:function:: generate_square_wave(width: float, mod_depth: float, sample_rate: int, duration: float) -> numpy.ndarray

   Generates a square wave with a given duty cycle (width ∈ [0, 1]).


.. py:class:: PWMPlot(width: int = JDXiStyle.ADSR_PLOT_WIDTH, height: int = JDXiStyle.ADSR_PLOT_HEIGHT, envelope: dict = None, parent: PySide6.QtWidgets.QWidget = None)
