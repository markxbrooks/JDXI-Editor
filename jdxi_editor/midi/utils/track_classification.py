...
STRINGS_KEYWORDS = ["string", "violin", "viola", "cello", "viola", "orchestra", "ensemble", "symphony"]
        ...
        if msg.type == "note_on" and msg.velocity > 0:
            ...
            if note in note_on_times:
                ...
                for other_note, other_start in note_on_times.items():
                    if other_note != note and other_start > note_on_times[note] and other_start < absolute_time:
...
def _calculate_keys_guitars_score(analysis: dict) -> None:
    ...
    if analysis["note_count"] > 0:
        mid_percentage = (analysis["mid_range_note_count"] / analysis["note_count"]) * 100
