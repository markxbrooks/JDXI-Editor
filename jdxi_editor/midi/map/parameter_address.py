...
PARAMETER_ADDRESS_NAME_MAP = {
    ...
    (TemporaryToneUMB.DIGITAL_SYNTH_1.name,
     SuperNATURALLMB.COMMON.name): DigitalCommonParam,
    (TemporaryToneUMB.DIGITAL_SYNTH_1.name, SuperNATURALLMB.MODIFY.name): DigitalModifyParam,
    (TemporaryToneUMB.DIGITAL_SYNTH_1.name,
     SuperNATURALLMB.PARTIAL_1.name): DigitalPartialParam,
    (TemporaryToneUMB.DIGITAL_SYNTH_1.name,
     SuperNATURALLMB.PARTIAL_2.name): DigitalPartialParam,
    (TemporaryToneUMB.DIGITAL_SYNTH_1.name,
     SuperNATURALLMB.PARTIAL_3.name): DigitalPartialParam,
    (TemporaryToneUMB.DIGITAL_SYNTH_2.name,
     SuperNATURALLMB.COMMON.name): DigitalCommonParam,
    (TemporaryToneUMB.DIGITAL_SYNTH_2.name, SuperNATURALLMB.MODIFY.name): DigitalModifyParam,
    (TemporaryToneUMB.DIGITAL_SYNTH_2.name,
     SuperNATURALLMB.PARTIAL_1.name): DigitalPartialParam,
    (TemporaryToneUMB.DIGITAL_SYNTH_2.name,
     SuperNATURALLMB.PARTIAL_2.name): DigitalPartialParam,
    ...
    (TemporaryToneUMB.DRUM_KIT.name, ProgramLMB.COMMON.name): DrumCommonParam,  # Default to Drums
