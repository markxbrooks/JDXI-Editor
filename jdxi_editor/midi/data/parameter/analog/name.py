...
class AnalogDisplayName:
    ...
    LFO_RATE = "Rate"
    LFO_RATE_MODULATION_CONTROL = "Rate Modulation"
    LFO_FADE_TIME = "Fade Time"
    LFO_PITCH_DEPTH = "Pitch Depth"
    LFO_PITCH_MODULATION_CONTROL = "Pitch Modulation"
    LFO_FILTER_DEPTH = "Filter Depth"
    LFO_FILTER_MODULATION_CONTROL = "Filter Modulation"
    ...
    OSC_PULSE_WIDTH = "Pulse Width"
    OSC_PULSE_WIDTH_MOD_DEPTH = "Pulse Width Mod Depth"
    OSC_PITCH_ENV_VELOCITY_SENSITIVITY = "Velocity Sensitivity"
