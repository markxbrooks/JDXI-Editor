...
class ADSR(EnvelopeWidgetBase):
    ...
    def __init__(
        ...
        if peak_param:
            ...
            # The regular slider from SLIDER_GROUPS will remain in the Controls tab
            ...
            # Only store in controls if it doesn't already exist (to avoid overwriting SLIDER_GROUPS slider)
