...
class SearchableFilterableComboBox(QWidget):
    ...
    valueChanged = Signal(int)  # Emitted when selected value changes (original value, not filtered index)
    ...
    def __init__(
        ...
        self._full_values = values.copy() if values else list(range(len(self._full_options)))
        self._categories = categories or []
        self._category_filter_func = category_filter_func or self._default_category_filter
