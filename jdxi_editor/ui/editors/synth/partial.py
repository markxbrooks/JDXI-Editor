...
from jdxi_editor.midi.data.address.parameter import TemporaryParameter, ProgramGroupParameter
...
class PartialEditor(SynthBase):
    ...
    def __init__(self, midi_helper=None, partial_number=1, part=TemporaryParameter.DIGITAL_PART_1, parent=None):
        super().__init__(midi_helper, parent)
        self.bipolar_parameters = []
        self.midi_helper = midi_helper
        self.area = None
        self.part = part
        self.group = ProgramGroupParameter.PROGRAM_COMMON
