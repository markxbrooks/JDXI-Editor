...
class DigitalSynthEditor(BaseSynthEditor):
    ...
    def __init__(
        ...
        super().__init__(
            midi_helper=midi_helper, preset_helper=preset_helper, parent=parent
        )
    ...
    def _setup_tabs(self, container_layout: Any, midi_helper: MidiIOHelper) -> None:
        """
        ...
        self.tone_modify_section = DigitalToneModifySection(
            send_midi_parameter=self.send_midi_parameter, midi_helper=midi_helper
        )
