...
class DrumTVASection(QWidget):
    ...
    def setup_ui(self):
        ...
        tva_level_velocity_sens_slider = self._create_parameter_slider(
            DrumPartialParam.TVA_LEVEL_VELOCITY_SENS, "Level Velocity Sens"
        )
