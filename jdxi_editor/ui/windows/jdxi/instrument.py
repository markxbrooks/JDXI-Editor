...
class JDXiInstrument(JDXiWindow):
    ...
    def _show_log_viewer(self) -> None:
        ...
        log.message(scope="JDXiInstrument", message="Showing LogViewer window")
    ...
    def _show_midi_debugger(self) -> None:
        ...
        if not self.midi_helper:
            log.message(scope="JDXiInstrument", message="MIDI helper not initialized")
            return
    ...
    def _on_program_name_received(self, program_name: str) -> None:
        ...
        log.message(f"📝 Program name received: {program_name}", scope="JDXiInstrument")
