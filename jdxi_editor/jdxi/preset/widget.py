...
from PySide6.QtWidgets import QWidget, QGroupBox, QVBoxLayout, QHBoxLayout, QLabel, QPushButton, QTabWidget, QLineEdit, QComboBox
...
class InstrumentPresetWidget(QWidget):
    ...
    def create_instrument_image_group(self) -> tuple[QGroupBox, Any, Any]:
        ...
        return instrument_image_group, self.instrument_image_label, instrument_group_layout
