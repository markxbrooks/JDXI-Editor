...
class MidiIn:
    ...
    def _create_mock():
        ...
        class MockMidiIn:
            ...
            def ignoreTypes(self, sysex, timing, active_sense):
                pass
...
if not hasattr(rtmidi, "MidiIn") or (
    hasattr(rtmidi, "MidiIn") and rtmidi.MidiIn is not MidiIn
):
    rtmidi.MidiIn = MidiIn
if not hasattr(rtmidi, "MidiOut") or (
    hasattr(rtmidi, "MidiOut") and rtmidi.MidiOut is not MidiOut
):
